...
/**
    public LinkedList<ClsEleccion> obtenerElecciones() {
        ...
        try {
            ...
            PreparedStatement sentencia = this.jdbc.conexio.prepareStatement(consulta);
    ...
    public LinkedList<ClsCandidato> obtenerCandidatosEleccion(String idEleccion) {
        ...
        try {
            ...
            while (resultados.next()) {
                ...
                int voto =resultados.getInt("voto");

                ClsCandidato candidato = new ClsCandidato(cedula, nombre, telefono, partido, cedula, 
                        descripcion, mensajeCampania, partido, voto);
                lista.add(candidato);
            }
