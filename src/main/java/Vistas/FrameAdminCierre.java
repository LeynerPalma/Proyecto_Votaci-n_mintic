 ...
 * @author leine
 */
public class FrameAdminCierre extends javax.swing.JFrame {
    //JFrame FrameVotante;
     ...
     */
    public FrameAdminCierre(JFrame FrameMenu, JFrame Frame_ControlVotacion) {
        initComponents();
        this.FrameMenu = FrameMenu;
        this.Frame_ControlVotacion = new FrameControlVotacion(FrameMenu);
    ...
    public void clear() {
        this.userAdmin.setText("");
        this.contrasenaAdmi.setText("");
    ...
    private void ingresarAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresarAdminActionPerformed
        ...
        if (tool == 1 && tool2 == 2) {
            ...
            this.Frame_ControlVotacion.setVisible(true);
            this.dispose();
            return;
        }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameAdminCierre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameAdminCierre(null, null).setVisible(true);
            }
        });
    }
